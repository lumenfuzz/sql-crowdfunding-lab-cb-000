...
"SELECT Users.name, User.age, SUM(Pledges.amount) FROM Pledges INNER JOIN Users ON Pledges.user_id = Users.id GROUP BY Pledges.user_id ORDER BY User.name ASC;"
end
