...
"SELECT Users.name, SUM(Pledges.amount) FROM Pledges INNER JOIN Users ON Pledges.user_id = Users.id GROUP BY Pledges.user_id ORDER BY Pledges.amount, Users.name;"
end
